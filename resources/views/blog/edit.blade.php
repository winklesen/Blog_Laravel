...
<a href="{{route('admin.index')}}" class="btn btn-primary mb-3">
    ...
    <div class="card col-8 mx-auto">
        <div class="card-body">
            <h2 class="text-center font-weight-bold">Edit Post</h2>            
            <form action="{{ route('update',$blog->id) }}" method="Post" enctype="multipart/form-data">
                  @csrf
                  <img class="w-100" src="{{ asset('storage/img/') }}{{ '/' . $blog->img}}" alt="">
                {{--  Gambar  --}}
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" id="title" placeholder="Judul postingan"  value="{{$blog->title}}">
                </div>                
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="tag" id="tag" placeholder="#tag1, #tag2, #tag3"  value="{{$blog->tag}}">
                </div>                
                {{--  Konten  --}}
                <div class="form-group">
                    <label for="isi">Konten</label>
                    <textarea name="isi" id="mytextarea" cols="30" rows="10" class="form-control">{{$blog->isi}}</textarea>
